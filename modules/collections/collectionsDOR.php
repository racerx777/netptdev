...
// Format message fields and use notes system to insert note
	...
	$doruser=getuser();
	$caid=$appid;
	$note="Request to prepare DOR Date:$date Charges:$charges Payments:$payments Lien Amount:$doramount ";
	...
	$query = "
		...
		SET cadorstatus='RD', cadordate='$datetime', cadoruser='$doruser'
		WHERE caid='$caid'
	";
  ...
  <form method="post" name="noteEditForm">
    <fieldset style="text-align:center;">
      ...
      <table cellpadding="5" cellspacing="0">
        <tr>
          <th colspan="3">Request to Prepare DOR</th>
        </tr>
        <tr>
          <td> Charges </td>
        ...
        <tr>
          <td colspan="3"><input id="submitbutton" name="submitbutton" type="submit" value="Confirm request to prepare DOR" />
