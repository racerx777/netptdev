...
document.title="Collection Print Appeal Letter"
...
function checkinput() {
	...
	var vsubmitbutton = document.getElementById("CreateAppealLetter");
...
if(isset($_POST['CreateAppealLetter'])) {
// Format message fields and use notes system to insert note
	...
	$note="Appeal Letter Date:$date Amount:$amount Via:$sendvia Adj:$insadjuster Ins:$insname $insaddress $inscity $insstate $inszip";
...
foreach($_POST as $key=>$val)
	...
	echo("<script>");
	echo("window.open('/modules/collections/collectionsPrintForms.php?$req','CreateAppealLetter');");
...
?>
<script>
document.getElementById("CreateAppealLetter").disabled=false;
</script>
<?php
}
?>
<div class="centerFieldset">
	<form method="post" name="noteEditForm">
		<fieldset style="text-align:center;">
			<legend> Send Appeal Letter for <?php echo "$bnum $pnum - $patientname" ?></legend>
			<table cellpadding="5" cellspacing="0">
				...
				<tr>
					<td colspan="2"><input name="CreateAppealLetter" id="CreateAppealLetter" type="submit" value="Create Appeal Letter" /></td>
