...
// Format message fields and use notes system to insert note
	...
	$note="Case is actively treating. Followup after $pendingdays days ($date). ".$_POST['note'];
	...
	<form method="post" name="noteEditForm">
		<fieldset style="text-align:center;">
			...
			<table cellpadding="5" cellspacing="0">
				<tr>
					<th colspan="3">Set <?php echo $bnum; ?> Active Case Follow-up</th>
				</tr>
				<tr>
					<td>Actively Treating Case Follow-up</td>
				...
				<tr>
					<td><input id="submitbutton" name="submitbutton" type="submit" value="Set Actively Treating Follow-up" disabled="disabled" /></td>
