...
document.title="Collection Print Reconsideration Letter"
...
function checkinput() {
	...
	var vsubmitbutton = document.getElementById("CreateReconsiderationLetter");
...
if(isset($_POST['CreateReconsiderationLetter'])) {
// Format message fields and use notes system to insert note
	...
	$fromdate=displayDate($_POST['fromdate']);
	$thrudate=displayDate($_POST['thrudate']);
	...
	$note="Reconsideration Date:$date Amount:$amount Date of Service:$fromdate-$thrudate Via:$sendvia Adj:$insadjuster Ins:$insname $insaddress $inscity $insstate $inszip";
...
foreach($_POST as $key=>$val)
	...
	echo("<script>");
	echo("window.open('/modules/collections/collectionsPrintForms.php?$req','CreateReconsiderationLetter');");
...
<div class="centerFieldset">
  <form method="post" name="noteEditForm">
    <fieldset style="text-align:center;">
      <legend> Send Reconsideration Letter for <?php echo "$bnum $pnum - $patientname" ?></legend>
      <table cellpadding="5" cellspacing="0">
        ...
        <tr>
          <td colspan="2"><input name="CreateReconsiderationLetter" id="CreateReconsiderationLetter" type="submit" value="Create Reconsideration Letter"  /></td>
