...
if($_POST['update']=='Update') {
	if(!empty($_POST['caid'])) {
        ...
        if (!$updateresult) {
        	...
        	error_log($error, 3, '/home/wsptn/public_html/netpt/update_error.log');      
        }

        if ($_POST['psid']) {
            //dump('update', 'update');
            $_POST['iscommercial'] = (isset($_POST['iscommercial'])) ? $_POST['iscommercial'] : 0;
            var_dump($_POST['iscommercial']);
            $sql = "UPDATE patients_status
                    SET
                        cicstatus = '".mysqli_escape_string($dbhandle,$_POST['cicstatus'])."',
                        cicdate = '".mysqli_escape_string($dbhandle,$_POST['cicdate'])."',
                        surgeon = '".mysqli_escape_string($dbhandle,$_POST['surgeon'])."',
                        surgerydate1 = '".mysqli_escape_string($dbhandle,$_POST['surgerydate1'])."',
                        surgerybodypart = '".mysqli_escape_string($dbhandle,$_POST['surgerybodypart'])."',
                        refdoctor1 = '".mysqli_escape_string($dbhandle,$_POST['refdoctor1'])."',
                        refdoctor2 = '".mysqli_escape_string($dbhandle,$_POST['refdoctor2'])."',
                        refdoctor3 = '".mysqli_escape_string($dbhandle,$_POST['refdoctor3'])."',
                        casedenialdate = '".mysqli_escape_string($dbhandle,$_POST['casedenialdate'])."',
                        reasonfordenial = '".mysqli_escape_string($dbhandle,$_POST['reasonfordenial'])."',
                        acceptedbodypart = '".mysqli_escape_string($dbhandle,$_POST['acceptedbodypart'])."',
                        accepteddate = '".mysqli_escape_string($dbhandle,$_POST['accepteddate'])."',
                        pqmedate = '".mysqli_escape_string($dbhandle,$_POST['pqmedate'])."',
                        cabto = '".mysqli_escape_string($dbhandle,$_POST['cabto'])."',
                        wcabhearing = '".mysqli_escape_string($dbhandle,$_POST['wcabhearing'])."',
                        medlegaldoctor = '".mysqli_escape_string($dbhandle,$_POST['medlegaldoctor'])."',
                        overallstatus = '".mysqli_escape_string($dbhandle,$_POST['overallstatus'])."',
                        doi2 = '".mysqli_escape_string($dbhandle,$_POST['doi2'])."',
                        dorstatusdate = '".mysqli_escape_string($dbhandle,$_POST['dorstatusdate'])."',
                        lienstatusdate = '".mysqli_escape_string($dbhandle,$_POST['lienstatusdate'])."',
                        ct = '".mysqli_escape_string($dbhandle,$_POST['ct'])."',
                        chartnotes = '".mysqli_escape_string($dbhandle,$_POST['chartnotes'])."',
                        candr = '".mysqli_escape_string($dbhandle,$_POST['candr'])."',
                        casewatch = '".mysqli_escape_string($dbhandle,$_POST['casewatch'])."',
            ...
            $sql = "INSERT INTO patients_status
                    ...
                    VALUES (
                        '".$_POST['bnum']."',
                        '".$_POST['pnum']."',
                        '".mysqli_escape_string($dbhandle,$_POST['cicstatus'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['cicdate'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['surgeon'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['surgerydate1'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['surgerybodypart'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['refdoctor1'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['refdoctor2'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['refdoctor3'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['casedenialdate'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['reasonfordenial'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['acceptedbodypart'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['accepteddate'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['pqmedate'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['cabto'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['wcabhearing'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['medlegaldoctor'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['overallstatus'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['doi2'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['lienstatusdate'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['dorstatusdate'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['ct'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['chartnotes'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['candr'])."',
                        '".mysqli_escape_string($dbhandle,$_POST['casewatch'])."',
                        '".$_POST['iscommercial']."'
                    )";
            //dump('sql', $sql);
            mysqli_query($dbhandle,$sql);
...
if(!empty($_SESSION['navigationid']) && !empty($_SESSION['button'])) {
	...
	foreach($argv as $index=>$expression) {
		list($field,$value)=explode("=", $expression);
...
if(empty($app) || empty($appid)) {
	if(empty($bnum) || empty($pnum)) {
		...
		$where = "p.bnum='$bnum' and p.pnum='$pnum'";
}
else
	$where = "caid='$appid'";
...
// If the collection account has not been updated then default values to PTOS values
	if(empty($_POST['upddate']) || $_POST['upddate'] == null || $_POST['upddate'] == "0000-00-00 00:00:00") {
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div id="right-column">
                                                    ...
                                                    <div class='status-block'>
                                                        <label for="iscommercial">Is Account Commerical?</label>
                                                        <input type="checkbox" name="iscommercial" value="1" <?php if ($_POST['iscommercial']) { echo "checked='checked'"; } ?> />
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
