...
//	dump("acctype",$_SESSION['useraccess']['patients'][$_POST['thpnum']]['acctype']);
}

if($_POST['thctmcode']=='15') $_POST['thctmcode']='5'; 
else if($_POST['thctmcode']=='16') $_POST['thctmcode']='6';
	else if($_POST['thctmcode']=='17') $_POST['thctmcode']='6';
		else if($_POST['thctmcode']=='18') $_POST['thctmcode']='6';
			else if($_POST['thctmcode']=='19') $_POST['thctmcode']='6';
				else if($_POST['thctmcode']=='61') $_POST['thctmcode']='61';
					else if($_POST['thctmcode']=='62') $_POST['thctmcode']='61';
						else if(substr($_POST['thctmcode'],0,1)=='2') $_POST['thctmcode']='2';
							else if(substr($_POST['thctmcode'],0,1)=='3') $_POST['thctmcode']='3';
								else if(substr($_POST['thctmcode'],0,1)=='4') $_POST['thctmcode']='5';
									else if(substr($_POST['thctmcode'],0,1)=='5') $_POST['thctmcode']='5';
										else if(substr($_POST['thctmcode'],0,1)=='6') $_POST['thctmcode']='6';
											else if(substr($_POST['thctmcode'],0,1)=='7') $_POST['thctmcode']='6';
												else if(substr($_POST['thctmcode'],0,1)=='8') $_POST['thctmcode']='8';
													else if(substr($_POST['thctmcode'],0,1)=='9') $_POST['thctmcode']='9';
														else $_POST['thctmcode']='??';
...
<div class="containedBox">
	...
	<form method="post" name="editForm">
		...
		<label for="thctmcode">Case Type <?php echo $_POST['thctmcode']; ?><input type="hidden" name="thctmcode" value="<?php echo $_POST['thctmcode']; ?>" /></label>
...
<label for="thnadate" > Next Action Date
<input id="thnadate" name="thnadate" type="text" size="10" maxlength="10" value="<?php if(isset($_POST['thnadate'])) echo $_POST['thnadate']; ?>"  onchange="validateDate(this.id)">
					<img  align="absmiddle" name="thnadate1" id="thnadate1" src="/img/calendar.gif" onclick="cal.select(document.forms['addForm'].thnadate,'thnadate1','MM/dd/yyyy'); return false;" />
</label>
		<br />
		<?php 
if(isuserlevel(23)) {
...
?>
			<div>
				...
				<input class="individualprocedureClass" name="individualprocedures[<?php echo $ttkey; ?>][<?php echo $ipkey; ?>]" type="checkbox" value="<?php echo $ipkey; ?>" <?php echo $checkedindividualprocedures["$ttkey"]["$ipkey"]; ?> >
...
?>
		<div style="clear:both;">
			...
			<div style="float:right;">
				<input name="button[<?php echo $_SESSION['id']; ?>]" type="submit" value="<?php echo $action; ?>" />
			</div>
		</div>
	</form>
	</fieldset>
