...
if(!empty($_SESSION['id']) && $_SESSION['id']!= 0) {
	...
	//if(mysqli_num_rows(mysqli_query($dbhandle,"SELECT * FROM case_scheduling_queue where csqid='".$_SESSION['id']."'"))){
		$query = "
...
<div class="centerFieldset" style="margin-top:100px;">
	<form action="" method="post" name="cancelForm">
		...
		<table style="text-align:left;">
			...
			<tr>
				<td>Cancel Date </td>
				<td><?php echo date("m/d/Y H:i:s", $casecanceldate); ?> </td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2"><div>
						...
						<div style="float:left; margin:20px;">
							<input name="button[<?php echo $_POST['csqid']; ?>]" type="submit" value="<?php echo $buttonvalue; ?>" />
						</div>
					</div></td>
			</tr>
		</table>
