...
$TEST_GROUP='MUSCLE';
$test_group='muscle';
$test_group_title="Muscle Group Name";
...
//$options['rdbtresult']=getSelectOptions($arrayofarrayitems=$valid_test_values_special, $optionvaluefield='value', $arrayofoptionfields=array('value'=>''), $defaultoption=NULL, $addblankoption=FALSE, $arraykey=NULL, $arrayofmatchvalues=array());
