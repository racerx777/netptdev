...
function pdf_pagewidth() {
	return(612);
}

function pdf_pageheight() {
	return(792);
}

function pdf_reportwrap() {
	return(100);
}

function pdf_pagemarginleft() {
	return(32);
}

function pdf_pagemarginright() {
	return(32);
}

function pdf_pagemargintop() {
	return(36);
}

function pdf_pagemarginbottom() {
	return(36);
}
...
function pdf_getdefaultfontcolor(){
	...
	$defaultfontcolor['r']=0;
	$defaultfontcolor['g']=0;
	$defaultfontcolor['b']=0;	
