...
?>
			...
			<tr>
				<td>Suite Number</td>
				<td><input name="cmaddress2" class="suite_no" type="text" size="30" maxlength="30" value="<?php if(isset($_POST['cmaddress2'])) echo $_POST['cmaddress2'];?>" />
				</td>
			</tr>
			<tr>
				<td>Clinic City</td>
...
<select name="ttmcode" id="ttmcode">
			...
			<tr>
				<td colspan="2"><div>
						...
						<div style="float:left; margin:20px;">
							<input name="button[<?php echo $_SESSION['id']; ?>]" type="submit" value="Update" class="update_btn" />
						</div>
					</div></td>
			</tr>
		</table>
...
(function($){
	...
	$('.suite_no').blur(function() {
		changeText();
	});
	function changeText(){
		var str = $('.suite_no').val()
		str = str.replace(/\s/g, '');
		str = str.toUpperCase();
