...
if(!empty($_SESSION['button']) && $_SESSION['button']=='Search Locations') {
	echo("Here");
	exit;
	$_POST['dmid'] = $_SESSION['id'];
...
if(!empty($_POST['buttonSearchDoctor'])) {
	setformvars('doctor', 'searchdoctor', $_POST['searchdoctor']);
...
<div class="containedBox">
	<fieldset>
		<legend>Search/Add Doctor Information</legend>
		<form method="post" name="searchDoctorForm">
			<table width="100%" border="1" cellspacing="0" cellpadding="3">
				...
				<tr>
					...
					<td>
						<input name="searchdoctor[drdlid]" type="text" size="11" maxlength="11"  value="<?php if(isset($default['drdlid'])) echo $default['drdlid'];  ?>">
					</td>
				</tr>
				<tr>
					<td colspan="8"><div>
							<div style="float:left;">
								<input id="SearchButton" name="buttonSearchDoctor" type="submit" value="Search Doctors"  />
							</div>
							<div style="float:left;">
