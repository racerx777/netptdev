...
function pdfPrivacyAcknowledgement($p, $settings, $data, $lang='en') {
	...
	pdf_putheader($p, 32, 700, "Privacy Practices Acknowledgement", $case['clinic'], $lang);
	$newbodytop = pdf_putpatientinformationshort($p, $bodyleft, $bodytop, $data, $lang); 	//	Patient Information
	$newbodytop = pdf_putprivacyacknowledgement($p, $bodyleft, $newbodytop-(12*(-6.5)), $data, $lang);//Current Privacy 
	pdf_end_page($p);
}
?>