...
<div class="centerFieldset" style="margin-top:100px;">
	...
	<input type="hidden" name="formLoaded" value="1" />
		...
		<legend>Docs Requested - prescription <?php echo $_POST['cpid']; ?><input type="hidden" name="cpid" value="<?php if(isset($_POST['cpid'])) echo $_POST['cpid']; ?>" /></legend>
		<table style="text-align:left;">
			<tr>
				<td valign="top">Documents Requested </td>
			...
			<tr>
				<td colspan="2"><div>
						...
						<div style="float:left; margin:20px;">
							<input name="button[<?php echo $_POST['cpid']; ?>]" type="submit" value="Confirm Requested Docs" />
						</div>
					</div></td>
			</tr>
		</table>
