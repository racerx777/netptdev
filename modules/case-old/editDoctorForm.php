	...
	<form method="post" name="editDoctorForm" >
		...
		<tr>
			...
			<td><input name="dmnpi" type="text" size="20" maxlength="30" value="<?php if(isset($_POST['dmnpi'])) echo $_POST['dmnpi'];?>" />
				<a href="https://nppes.cms.hhs.gov/NPPES/NPIRegistryPaginate.do?searchNpi=<?php echo $_POST['dmnpi']; ?>&city=&firstName=&orgName=&searchType=ind&state=&orgDba=&nextPage=1&lastName=&zip=" target="_blank">lookup</a> </td>
		</tr>
		<tr>
			<td>UPIN#</td>
