...
//execute the SQL query 
			...
			if($result) {
				notify("001", "Patient " . $values['palname'] . ", " . $values['pafname'] . " successfully updated.");
				foreach($fields[$table] as $fieldname=>$fieldtype) 
					unset($_POST["$fieldname"]);
				unset($_SESSION['button']);
				clearformvars('customerservice', 'search');
				$_POST['buttonSetSearch']='1';
				$_POST['search']['paid'] = $_SESSION['id'];
			}
			else 
...
//		setformvars('customerservice', 'search', $_POST);
		$_SESSION['button']='Edit Patient';
	}
