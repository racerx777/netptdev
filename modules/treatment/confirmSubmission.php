	...
	<form action="" method="post" name="treatmentSubmit">
		<div	id="container">
			...
			<div style="float:right">
				<input name="print" type="button" value="Print submitted list for your records" onclick="window.location='/modules/treatment/reports/printPdf.php?id=<?php echo implode(",", $thIds); ?>'">
			</div>
		</div>
	</form>
	</fieldset>
