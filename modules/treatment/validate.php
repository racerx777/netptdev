...
// If Existing Patient was selected, retrieve case type from case table
...
//	if($_POST['thvtmcode']!= 'DC' && $_POST['thvtmcode']!= 'DCW' && $_POST['thvtmcode']!= 'NPE' && $_POST['thvtmcode']!= 'RE' && $_POST['thvtmcode']!= 'REW' && $_POST['thvtmcode']!= 'REE') {
...
// If inserting/adding
if($_SESSION['button']=='Update' || $_SESSION['button']=='Add' || $_SESSION['button']=='Please wait adding...') {
...
//dump("patients",$_SESSION['useraccess']['patients'][$_POST['thpnum']]);
