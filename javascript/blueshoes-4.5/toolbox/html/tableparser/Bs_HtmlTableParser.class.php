...
*/?><?php
require_once($_SERVER["DOCUMENT_ROOT"] . "../global.conf.php");require_once($APP['path']['core'] . 'util/Bs_StopWatch.class.php');require_once($APP['path']['core'] . 'html/Bs_HtmlUtil.class.php');class Bs_HtmlTableParser extends Bs_Object {var $_tblNr = -1;         var $_theTable = array(); function Bs_HtmlTableParser () {parent::Bs_Object();$this->_Bs_HtmlUtil = &$GLOBALS['Bs_HtmlUtil']; }
      ...
      <head>
        ...
        <body bgcolor="#c0d0d0">
          <SPAN STYLE="font-family:Arial">
            <H1>HTML Table Parser</H1>
            Parses well formed XHTML TABLE (incl. cascading TABLEs) and generates 
