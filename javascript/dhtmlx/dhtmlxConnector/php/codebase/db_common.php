...
class MySQLDBDataWrapper extends DBDataWrapper{
	...
	public function query($sql){
		LogMaster::log($sql);
		$res=mysqli_query($dbhandle,$sql,$this->connection);
	...
	public function escape($data){
		return mysqli_real_escape_string($dbhandle,$data, $this->connection);
	}

	public function tables_list() {
		$result = mysqli_query($dbhandle,"SHOW TABLES");
	...
	public function fields_list($table) {
		$result = mysqli_query($dbhandle,"SHOW COLUMNS FROM `".$table."`");
		if ($result===false) throw new Exception("MySQL operation failed\n".mysql_error($this->connection));
