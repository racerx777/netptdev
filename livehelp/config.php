...
if($installed==true){
 ...
 $server = 'localhost';
 $database = 'netptwsp_lhlp1';
 $datausername = 'netptwsp_lhlp1';
 $password = 'mj0svoUsCB3n';
 ...
 $application_root = '/home/netwsptn/public_html/livehelp/';
 ...
 $API_HOME_DIR = '/home/netwsptn/public_html/livehelp/txt-db-api/';
