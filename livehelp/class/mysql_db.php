...
/**
  ...
  */ 
	function insert($sql=""){
		...
		$conn = $this->CONN;
		$results = mysqli_query($dbhandle,$sql,$conn);
		if(!$results) {
...
/**
  ...
  */               
	...
	{
		$this->CONN = $conn;
		$this->QID = mysqli_query($dbhandle,$sql,$conn);
  ...
  */  
  function next($fetchmode=DB_FETCHMODE_ASSOC){
       if($fetchmode==DB_FETCHMODE_ORDERED)
         $this->RECORDSET = mysqli_fetch_array($this->QID,MYSQL_NUM);        
       else
         $this->RECORDSET = mysqli_fetch_array($this->QID,MYSQL_ASSOC); 
