...
if($UNTRUSTED['createit'] != ""){
  ...
  (visible,nameof,offline,opening,messageemail,leaveamessage,requirename,onlineimage,offlineimage,whilewait,timeout,leavetxt,topframeheight,topbackcolor,midbackcolor,botbackcolor,topbackground,midbackground,botbackground,colorscheme,speaklanguage,busymess,smiles) 
  ...
  '".filter_sql($UNTRUSTED['topbackcolor']) . "','". filter_sql($UNTRUSTED['midbackcolor'])."',
  '".filter_sql($UNTRUSTED['botbackcolor']) . "','". filter_sql($UNTRUSTED['topbackground'])."',
  '".filter_sql($UNTRUSTED['midbackground']) . "','". filter_sql($UNTRUSTED['botbackground'])."',
  '". filter_sql($UNTRUSTED['colorscheme'])."',
...
if($UNTRUSTED['updateit'] != 0){
  ...
  $sqlquery = "UPDATE livehelp_departments 
            SET topframeheight=".intval($UNTRUSTED['topframeheight']).",
                ...
                midbackground='".filter_sql($UNTRUSTED['midbackground'])."',
                botbackground='".filter_sql($UNTRUSTED['botbackground'])."',
                topbackcolor='".filter_sql($UNTRUSTED['topbackcolor'])."',
                midbackcolor='".filter_sql($UNTRUSTED['midbackcolor'])."',
                botbackcolor='".filter_sql($UNTRUSTED['botbackcolor'])."', 
...
&lt;!-- copyright 2003 - 2009 by Eric Gerdes --&gt;<br><br>
</b></td></tr></table><br><br>
...
&lt;!-- copyright 2003 - 2009 by Eric Gerdes --&gt;<br>
</b><br><br>
...
<a href=http://www.craftysyntax.com/ target=_blank>Crafty Syntax Live Help</a> &copy; 2003 - 2009 by <a href=http://www.craftysyntax.com/EricGerdes/ target=_blank>Eric Gerdes</a>  
<br>
