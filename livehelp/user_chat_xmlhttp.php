...
$query = "SELECT recno,topbackground,midbackground,midbackcolor,colorscheme FROM livehelp_departments ";
...
<STYLE>
body { 
  background: url("<?php echo $midbackground; ?>"); 
  background-attachment: fixed;
}
	
</STYLE>
<body marginheight=0 marginwidth=0 leftmargin=0 topmargin=0 bgcolor="<?php echo $midbackcolor; ?>">
